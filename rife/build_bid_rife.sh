...
for j in {0..9}; do
    ...
    ffmpeg -i $rife_path/out_rife_ens_25.mp4 -filter:v "setpts=2*PTS" -y $rife_path/out_rife_ens_50.mp4
    ...
    #
    ffmpeg \
        -i $rife_path/out_rife_ens_25.mp4 \
        -filter_complex "\
    ...
    mv /tmp/a.mp4 $rife_path/out_rife_ens_25.mp4

    ffmpeg \
        -i $rife_path/out_rife_ens_50.mp4 \
        -filter_complex "\
            [0:v]drawtext=fontfile=/home/kbrodt/.local/share/fonts/lin/LinBiolinum_RB.ttf\
            :fontcolor=black\
            :fontsize=36\
    ...
    mv /tmp/a.mp4 $rife_path/out_rife_ens_50.mp4
